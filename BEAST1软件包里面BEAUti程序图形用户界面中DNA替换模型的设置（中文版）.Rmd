---
title: "BEAST1软件包里面BEAUti程序图形用户界面中DNA替换模型的设置（中文版）"
---


## BEAST1软件包里面BEAUti程序图形用户界面只给出了3种最流行的DNA替换模型: TrN、HKY和GTR。
## 这对于标准的11种替换模型来说还有8种（JC69、TrNef、K80、F81、SYM、TIM、TVM和TVMef）需要自己想办法解决。
